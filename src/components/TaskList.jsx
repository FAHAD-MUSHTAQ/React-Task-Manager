  ...
  return (
    <section className="flex items-center justify-center w-full lg:w-2/3 px-4 lg:px-16">
      <div className="container backdrop-blur-sm bg-[#0000002f] lg:bg-[#ffffff21] min-h-[15rem] lg:min-h-[10rem] lg:max-h-[86vh] p-4 rounded-lg">
        <h2 className="text-slate-100 font-bold text-xl mb-3 text-center">
          Todo List
        </h2>
        <div className="overflow-auto lg:max-h-[75vh] flex flex-col gap-3 rounded-lg scrollbar-hide">
          {!tasks.length == 0 ? (
            tasks.map((value, key) => (
              <div
                key={key}
                className="flex flex-col lg:flex-row justify-between lg:items-center gap-2 lg:gap-4 p-4 bg-white rounded-lg"
              >
                ...
                <div className="flex w-full lg:w-1/3 justify-around items-center">
                  <span
                    ...
                    } w-20 flex justify-center rounded-full px-2 py-1 text-xs`}
                  >
                  ...
                  <button
                    ...
                    } rounded-full inline-flex justify-center items-center h-10 w-10`}
                  ...
                  >
                    {!value.status ? (
                      <MdDone className="text-xl object-contain text-green-950" />
                    ) : (
                  ...
                  <button
                    type="button"
                    className="bg-red-600 hover:bg-red-700 text-white inline-flex justify-center items-center rounded-full h-10 w-10"
                    data-tooltip-id="action-tooltip"
                    data-tooltip-variant="dark"
